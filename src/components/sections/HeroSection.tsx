...
export default function HeroSection() {
  return (
    <section className="py-24 md:py-40 bg-gradient-to-br from-primary to-accent text-primary-foreground">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-5xl sm:text-6xl md:text-7xl font-bold mb-8 font-headline">
          Innovative Development, Tailored Solutions.
        </h2>
        <p className="text-lg sm:text-xl md:text-2xl mb-12 max-w-3xl mx-auto font-body">
